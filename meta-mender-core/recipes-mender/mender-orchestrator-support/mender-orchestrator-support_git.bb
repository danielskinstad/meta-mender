...
def mender_orchestrator_support_autorev_if_git_version(d):
    ...
    if not d.getVar("EXTERNALSRC") and version is not None and "git" in version:
        ...
        return "3487795664d01bb845d407fd23d16ee434b8b741"
...
def mender_orchestrator_support_branch_from_preferred_version(d):
    ...
    if match is not None:
        ...
        # TODO: this has to be changed to `main` once the feature branch is merged
        # Else return feature branch as default.
        return "feature/MEN-8416-orchestrator"
...
def mender_orchestrator_support_license(branch):
...
"
LICENSE = "${@mender_orchestrator_support_license(d.getVar('MENDER_ORCHESTRATOR_SUPPORT_BRANCH'))['license']}"
